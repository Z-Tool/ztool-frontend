    ...
    <el-col :span="6" :offset="9">
      <el-form :model="createForm" :rules="rules" ref="createForm" class="demo-ruleForm">
        ...
        <el-form-item prop="password">
          <el-input type="password" v-model="createForm.password" auto-complete="off" placeholder="Password"></el-input>
        </el-form-item>
        <el-form-item prop="confirmPassword">
          <el-input type="password" v-model="createForm.confirmPassword" auto-complete="off" placeholder="Confirm password"></el-input>
        </el-form-item>
        ...
        <router-link to="/user/login"><el-button type="warning" style="width: 100%;">Login</el-button></router-link>
      </el-form>
    </el-col>
  </el-row>
</div>
